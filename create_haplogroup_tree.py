...
def get_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("-i", "--input", required=True,
                        ...
                        metavar="FILE")
    parser.add_argument("-c", "--collapse_mode", help="If you add this flag all the nodes outside the main and final"
                                                      " nodes will be compressed together creating a signigicantly "
                                                      "smaller picture",
                        action="store_true")
